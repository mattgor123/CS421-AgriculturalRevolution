 ...
 * 
 */
public class SendGrainMode implements ClickMode {
    ...
    public String getName() {
        return "SEND " + TRANSFER_QUANTITY + " GRAIN";
    }

    @Override
    public String getDescription() {
        return "Fee: " + SettlementManager.GRAIN_TRANSFER_FEE + " GRAIN";
    }
    ...
    public void execute(GameViewController controller, MouseEvent event) {
        ...
        controller.getModel().getSettlementManager()
                .transferGrain(gifter, giftee, TRANSFER_QUANTITY);
